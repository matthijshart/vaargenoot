...
export const vragen = {
  ...
  lijst: [
    ...
    },
    {
      ...
      antwoord: `Twaalf keer het maandbedrag. ${producten.duo.naam} ${modellen.prinsen.naam}: ${bedrag(duo * 12)} per bedrijf per jaar. ${producten.solo.naam} ${modellen.prinsen.naam}: ${bedrag(solo * 12)} per jaar. Exclusief btw, indicatief. Daar zit alles in, wij regelen het: ligplaats in de grachtengordel of op een plek naar keuze, vergunningen en vignet, verzekering, opladen en stroom, onderhoud, winterklaar, vervangende sloep, app en servicelijn. Schipper en catering regel je erbij.`,
    },
    {
