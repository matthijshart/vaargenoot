...
export const privacy: typeof privacyNl = {
  ...
  blokken: [
    ...
    {
      kop: "Where it's kept",
      tekst: `Your message reaches us by email and sits in our mailbox and in the website's log files. We keep it as long as needed for your reservation or trial trip, and delete it after that.`,
    },
    {
      kop: "Your rights",
      tekst: `You can always ask what we have on you, have it corrected or deleted.${ingevuld(site.email) ? ` Email ${site.email}.` : " One message is enough."}`,
    },
    {
      kop: "Who",
      tekst: `${site.naam}, ${site.plaats}${ingevuld(site.kvk) ? `, Chamber of Commerce ${site.kvk}` : ""}.`,
    },
  ],
};
